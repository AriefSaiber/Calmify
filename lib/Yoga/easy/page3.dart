...
import 'package:Calmify/Yoga/easy/page4.dart';
import 'package:get/get.dart';
import 'package:video_player/video_player.dart';

class EasyPage3 extends StatefulWidget {
  const EasyPage3({super.key});

  @override
  State<EasyPage3> createState() => _EasyPage3State();
}

class _EasyPage3State extends State<EasyPage3> {
  static const maxSeconds = 60;
  int seconds = maxSeconds;
  Timer? timer;
  final VideoPlayerController _controller = VideoPlayerController.network(
      'https://thumbs.gfycat.com/ShyOccasionalEasternglasslizard-mobile.mp4');
                ...
                Container(
                  ...
                  child: Padding(
                    ...
                    child: Column(
                      children: [
                        Text(
                            '1. From Forward Fold, put your hands flat on the floor, bending your knees as much as needed to do so.',
                            style: TextStyle(
                              fontSize: 18,
                              color: Colors.white,
                            )),
