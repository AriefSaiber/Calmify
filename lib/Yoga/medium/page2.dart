...
import 'package:Calmify/Yoga/medium/page3.dart';
import 'package:get/get.dart';
import 'package:video_player/video_player.dart';

class MediumPage2 extends StatefulWidget {
  const MediumPage2({super.key});

  @override
  State<MediumPage2> createState() => _MediumPage2State();
}

class _MediumPage2State extends State<MediumPage2> {
  static const maxSeconds = 60;
  int seconds = maxSeconds;
  Timer? timer;
  final VideoPlayerController _controller = VideoPlayerController.network(
      'https://thumbs.gfycat.com/ObviousEarnestBovine-mobile.mp4');
                  ...
                  child: Padding(
                    ...
                    child: Column(
                      children: [
                        ...
                        Text(
                            '5. Bring your hand to your leg. Extend your left arm up toward the ceiling.',
                            style: TextStyle(
                              fontSize: 18,
                              color: Colors.white,
                            )),
                        Text('6. Look up, forward, or down.',
                            style: TextStyle(
                              fontSize: 18,
                              color: Colors.white,
                            )),
